...
plot(seq_along(x)-1, x, xlab="Delay (bp)", ylab="CCF", type="l")
...
```{r}
complex.db <- out.ranges$logFC.up > 0 & out.ranges$logFC.down > 0
cur.region <- out.ranges[o[complex.db[o]][2]]
cur.region
```
...
This is illustrated in Figure \@ref(fig:mdsplot2) where the WT libraries are clearly separated in both dimensions of the MDS plot.
